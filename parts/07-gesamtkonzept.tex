...
Um sowohl das Klemmen als auch das Anheben des Hindernis mit einem einzelnen Motor zu realisieren wurde der Mechanismus als ein Gestänge realisiert. Dieses Gestänge bewegt die einzelne Klemmbacke (rechts in Abb. \ref{fig:obstacle_clamping_concept}). Die beiden anderen Klemmbacken werden durch einen Federvorgespannten arm in einen Anschlag gedrückt, damit sie auf der richtigen Höhe befinden, um das Hinderniss zu Klemmen. 
\\
