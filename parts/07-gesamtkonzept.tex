...
Angenommen der Roboter fährt von links auf Knoten G zu, dann weiss er, dass er in einem rechten Winkel von links  kommt, sprich er kommt von 270\textdegree\ her. Er fotografiert die ausgehenden Kanten von Knoten G und erhält die Liste \verb|[0, 120, 180, 240, 300]|. Der erste Listeneintrag ist der Winkel woher er herkommt. Der zweite Winkel beschreibt dann hier im Beispiel die Linie von G nach E. 
Dies kann er berechnen, indem er weiss wie seine aktuelle Ausrichtung ist, und mit den Winkeln welche im internen Graphen gepseichert sind.

Wenn der Roboter sich in diese Richtung drehen möchte, dann addiert er den Offset (Woher er kommt + 180\textdegree) mit dem zweiten Listeneintrag. Falls die Zahl über 180\textdegree\ liegt dann wird diese noch -360\textdegree\ gerechnet, Falls weniger, ist dies schon der zu drehende Winkel.


\[DrehwinkelZuE=AktuelleAusrichtung+WinkelZuE=180^{\circ}+120^{\circ}=300^{\circ}\]

Da dieser Winkel über 180\textdegree\ liegt, wird dieser noch -360\textdegree\ gerechnet:

\[EffizienterDrehwinkelZuE=DrehwinkelZuE-360^{\circ}=-60^{\circ}\]

Somit muss sich der Roboter -60\textdegree\ drehen. Das heisst, 60\textdegree\ im Gegenuhrzeigersinn, nach links.
