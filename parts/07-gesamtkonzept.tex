...
Das Fahrzeug wird mit zwei einzeln angesteuerten Räder angetrieben. Dabei wird sowohl das Forwärtsfahren, als auch das Drehen von den Rädern durchgeführt. Die \acrfull{dc} Motoren besitzen Encoder und sind direkt mit den Antriebsrädern verbunden. Dadurch kann genau festgestellt werden, welche Distanz zurückgelegt wurde. Der Fahrbefehl entsteht aufgrund der Berechnungen der Bilderkennung. Dem Mikrocontroller \gls{tinyk22}, der die Motoren ansteuert, werden Distanz und Drehwinkel mitgeteilt.
