...
\hline
  \textbf{Nr.} & \textbf{Spezifikation} & \textbf{Schalter} \\
  \hline
  1  & Der Zielknoten kann manuell und  & Der Schalter wird gedrückt und löst den Not-Stop aus.\\
  \hline
...
Morphologischer Kasten (ev. Fliesstext)
