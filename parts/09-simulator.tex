...
Sind die Vorbedingungen erfüllt, kann im Grundverzeichnis des Simulators nachfolgender Befehl ausgeführt werden, um eine einfache Simulation zu starten:
...
Dies gibt uns Hinweise über alle möglichen Aktionen. Die wichtigsten nachfolgend erklärt:
...
Der Verlauf kann auch im Grafischen User Interface verfolgt werden. Dabei sind in Farbe die Hindernisse welche bereits erkannt worden sind. Sowie schwarz der Pfad, der bekannt ist. Grau hingegen sind alle Pfade und Hindernisse welche zu dem Zeitpunkt noch unbekannt sind.
Die Anzeige aktualisiert sich stetig.
\begin{figure}[H]
    \centering
...
Für uns ist dabei wichtig, dass wir unter einer Laufzeit von ca. 2 Minuten stehen, egal welcher Graph mit welchen Hindernissen wir traversieren müssen.
...
Wie zu sehen ist, braucht der Roboter im worst case ungefähr 200 Sekunden für das Traversieren. Welches immernoch unter den geforderten Muss-Anforderungen von 240 Sekunden ist. 
