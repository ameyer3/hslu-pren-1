...
\begin{tabularx}\textwidth{X X X X}
    ...
    &&\\
    Werkstoffe  & Eingabeoptionen & Wegfindung & Wegenetz einlesen\\ 
    Fortbewegung  & Ausgabeoptionen & Bilderkennung & Wegenetz speichern\\ 
...
\textbf{} & \textbf{Mecanumwheel} & \textbf{Überlagerungslenkgetriebe} \\
  ...
  \hline
  \textbf{Links} & \url{https://www.generationrobots.com/media/Mecanum-wheel-application.pdf?srsltid=AfmBOorTpuZt7XtV3qQiRZx3OUkmpaGSvG7AvhzuWbz61Fu4mzv7UaZ2} & \url{https://de-academic.com/dic.nsf/dewiki/1563250} \\
  \hline
  ...
  \hline
  \textbf{Links} & \url{https://the-contact-patch.com/book/road/c0504-ackermann-geometry} & \url{https://www.roboticsbook.org/S52_diffdrive_actions.html} \\
  \hline
\end{tabularx}
\caption{Lenkung}
...
Um die Motoren präzise anzusteuern, ist die Wahl einer geeigneten Regelungs- und Steuerungslösung erforderlich.
...
\begin{tabularx}{\textwidth}{|l|X|X|}
\hline
  \textbf{} & \textbf{Eingekauft} & \textbf{Eigenbau} \\
  \hline
  \textbf{Beschreibung}  & Motorsteuerungslösung für Plug and Play fertiggestellt& Selbstausgelegte Steuerung mit diskreten Bauteilen\\
  \hline
  \textbf{Vorteile}  & \makecell{-Einfache Auslegung\\-Platzeffizient\\-Leicht} & \makecell{-Es wird mehr gelernt}\\
  \hline
  \textbf{Nachteile} & \makecell{-} & \makecell{-Stabilität\\-Platz verbrauch}\\
  \hline
  \textbf{Links} &  \url{https://www.fruugoschweiz.com/dc-motorsteuerung-6v-60v-30a-motortreibersteuerung-mit-variabler-geschwindigkeit-und-digitalanzeige/p-298495890-668053866?language=de&ac=bing&msclkid=aa2b3e49129810d126835952913e3a21&utm_source=bing&utm_medium=cpc&utm_campaign=All_190785_CH&utm_term=2323474228534207&utm_content=Ad%20group%20%231} & \url{https://doku.el-voss.de/de/arduinoskript/elektrik/transistoren-motoren/elektromotoren-mit-einem-motortreiber-steuern}\\
  \hline
\end{tabularx}
...
\hline
  ...
  \hline
  \textbf{Vorteile}  & \makecell{-} & \makecell{-einfach und robust}\\
  \hline
  \textbf{Nachteile} & \makecell{-Implementierungsaufwand} & \makecell{-keine genauen Daten}\\
  \hline
  \textbf{Links} & \url{https://www.pi-shop.ch/pimoroni-display-o-tron-3000} & \url{https://de.wikipedia.org/wiki/Leuchtdiode}\\
\hline
...
\hline
  ...
  \textbf{Nachteile} & \makecell{-Implementierungsaufwand} & \makecell{-keine genauen Daten}\\
  \hline
   \textbf{Links} & \href{https://www.pi-shop.ch/pimoroni-display-o-tron-3000} & \url{https://de.wikipedia.org/wiki/Leuchtdiode}\\
  \hline
\end{tabularx}
...
\textbf{} & \textbf{Balkenanzeige} & \textbf{} \\
  ...
  \hline
  \textbf{Links} & \url{https://www.mouser.ch/ProductDetail/Kingbright/DC10EWA?} & \\
  \hline
\end{tabularx}
...
\hline
  ...
  \hline
  \textbf{Links} &  \url{https://de.wikipedia.org/wiki/Notausschalter} & \url{https://de.wikipedia.org/wiki/Schalter_(Elektrotechnik)}\\
  \hline
\end{tabularx}
