...
Es gibt verschiedene Möglichkeiten ein Fahrzeug bzw. eine Hebevorrichtung zu realisieren. 
...
\textbf{} & \textbf{Bionischer Greifer}&\textbf{Parallel Greifer}&\\
  \hline
  \textbf{Beschreibung} &      Bionischer Greifer zum Aufheben des Hindernis&     \\
  \hline
  \textbf{Vorteile} & \makecell{-gute Haftung durch flexible Kontur \\ -Greifkräfte können geregelt werden}&\\
  \hline
  \textbf{Nachteile}& \makecell{-aufwändige Ansteuerung \\ -teuer in der Anschaffung}&     \\
  \hline
  \textbf{Links}  &   \url{https://www.festo.com/ch/de/e/ueber-festo/forschung-und-entwicklung/bionic-learning-network/highlights-2010-2012/bionischer-handling-assistent-id_33759/}       &   \\
  \hline
\end{tabularx}
...
Zur befahren vom System und Steuerung von Gerät wird eine logic benötig.
