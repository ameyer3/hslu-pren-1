...
\hline
  ...
  \hline
  \textbf{Nachteile} & \makecell{-Gewicht} & \makecell{-keine Spannungsstabilität\\-keine langen grosse Ströme möglich}\\
  \hline
...
\hline
  ...
  \hline
  \textbf{Links} & https://www.elektronik-kompendium.de/sites/com/1907171.htm& https://www.raspberrypi.com\\
  \hline
\end{tabular}
\caption{Steuerung}
\label{table:et-object-detection-compare}
