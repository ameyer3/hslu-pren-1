...
\hline
  ...
  \hline
  \textbf{Vorteile}  & \makecell{-hohe spezifische Festigkeit\\ -gute Wärmeleitfähigkeit \\ -Normteile verfügbar} & \makecell{-hohe Härte erreichbar \\-hoher E-Modul\\-hohe Festigkeit \\ -viele Normteile verfügbar}\\
  \hline
  \textbf{Nachteile} & \makecell{-Preis \\ -} & \makecell{-Preis\\-aufwendige Verarbeitung}\\
  \hline
  %\textbf{Links} &  https://de.wikipedia.org/wiki/Akkumulator & https://de.wikipedia.org/wiki/Batterie_(Elektrotechnik)\\
  %\$hline
\end{tabular}
\caption{Materialien}
\label{table:material-comparison}
\end{table}
