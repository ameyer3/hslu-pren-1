...
\subsubsection{Fahrwerk/Getriebe}
...
\hline
  ...
  & \makecell{-keine Lenkung\\-leicht\\-Punktwendung möglich} & \makecell{-instabil} 
  & \makecell{\url{https://en.wikipedia.org/wiki/Differential_wheeled_robot}}\\

\hline

\makecell{\textbf{Überlagerungslenkgetriebe}\\"Panzerlenkung"\\1 Motor mit 2 Ausgangswellen,\\ Drehzahl/Richtung unabhängig einstellbaer}
& \makecell{-nur 1 Motor\\-keine }
...
\hline
  ...
  \hline
  \textbf{Links} &  https://de.wikipedia.org/wiki/Schalter_(Elektrotechnik) & https://www.pi-shop.ch/display\\
  \hline
\end{tabular}
...
\hline
  ...
  \hline
  \textbf{Links} &  https://de.wikipedia.org/wiki/Summer_(Elektrik) & https://de.wikipedia.org/wiki/Leuchtdiode\\
  \hline
\end{tabular}
