...
\begin{tabularx}{\textwidth}{|l|X|X|}
\hline
\textbf{} & \textbf{YAMLl} & \textbf{JSON}\\
  \hline
  \textbf{Beschreibung} & Eine Datenseralisierungssprache die gut vom Mensch gelesen werden kann. &  \\
  \hline
  \textbf{Vorteile}  & \makecell{-sehr simpel} & \makecell{-Grössere Auswahl an Möglichkeiten \\ -Halterung meist inklusive \\ -Schwenkbar und Drehbar} \\
  \hline
  \textbf{Nachteile} & \makecell{-Kein Gehäuse \\ -Keine Halterung} & \makecell{} \\
  \hline
...
\textbf{} & \textbf{Bild} & \textbf{} \\
  ...
  \hline
  \textbf{Nachteile} & \makecell{-viel Aufwand & \makecell{} \\
  \hline
  \textbf{Links} & & \\
  \hline
\end{tabularx}
