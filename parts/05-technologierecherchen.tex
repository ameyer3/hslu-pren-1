...
\textbf{} & \textbf{PyTorch} & \textbf{OpenCV}\\
  ...
  \hline
  \textbf{Vorteile} & & \makecell{-Kein Internetzugang nötig \\ -Flache Lernkurve \\ -Grosse Community} \\
  \hline
  \textbf{Nachteile} & & \makecell{-Rechenintensiv \\ -schlechte Performance \\ -Nicht die beste Wahl für Deep-Learn-\\ing-Fähigkeiten} \\
  \hline
