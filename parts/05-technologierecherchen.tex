...
\begin{tabularx}{\textwidth}{|l|X|X|}
\hline
\textbf{} & \textbf{Raupen} & \textbf{Räder (Platzhalter)} \\
  \hline
  \textbf{Beschreibung}  & FZ wird über Ketten/Raupen angetrieben & Räder Platzhalterbeschreibung \\
  \hline
  \textbf{Vorteile}  & \makecell{-Punktwenden möglich\\-geringer spez. Bodendruck\\-hohe Traktion} & \makecell{-Platzhaltervorteil 1\\-Platzhaltervorteil 2}  \\
  \hline
  \textbf{Nachteile} & \makecell{-komplex\\-Gewicht\\-tiefe Vmax} & \makecell{-Platzhalternachteil 1\\-Platzhalternachteil 2} \\
  \hline
  \textbf{Links} & \url{https://de.wikipedia.org/wiki/Kettenfahrzeug} & \url{https://example.com/raeder} \\
  \hline
\end{tabularx}
...
\textbf{} & \textbf{Omniwheel} & \textbf{Überlagerungslenkgetriebe} \\
  ...
  \hline
  \textbf{Nachteile} & \makecell{-komplexer Aufbau\\-schlechte tranktion\\-nicht robust} & \makecell{-Getriebe mit Verlusten\\-komplexer Aufbau} \\
  \hline
  \textbf{Links} & \url{https://en.wikipedia.org/wiki/Mecanum_wheel} & \url{https://de.wikipedia.org/wiki/Überlagerungslenkgetriebe} \\
  \hline
  
  \hline
  \textbf{} & \textbf{Lenkgetriebe} & \textbf{Differential Wheel Drive} \\
  \hline
  \textbf{Beschreibung}  & Umwandlung Rotation in unterschiedliche Einschlagwinkel am& 2 einzeln Angetriebene Räder, 1 Schwenkrad \\
  \hline
  \textbf{Vorteile}  & \makecell{-simpler Aufbau\\-1 Aktuator} & \makecell{-kein Lenkgestänge\\-leicht\\-Punktwendung möglich}  \\
  \hline
  \textbf{Nachteile} & \makecell{-begrenzter Einschlag} & \makecell{-instabil\\-2 Antriebsmotoren} \\
  \hline
  \textbf{Links} & \url{https://de.wikipedia.org/wiki/Lenkgetriebe} & \url{https://en.wikipedia.org/wiki/Differential_wheeled_robot} \\
  \hline
\end{tabularx}
\caption{Lenkung}
