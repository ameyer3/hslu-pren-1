...
\begin{tabularx}{\textwidth}{|l|X|X|}
\hline
  \textbf{} & \textbf{Ultraschall} & \textbf{Optoelektrisch} & \textbf{}\\
  \hline
...
\begin{tabularx}{\textwidth}{|l|X|X|}
\hline
  \textbf{} & \textbf{Fototransistor} & \textbf{Farbsensor} & \textbf{}\\
  \hline
  \textbf{Beschreibung}  & \makecell{} & \makecell{Die LED können aufleuchten um etwas\\ visuell anzuzeigen}\\
  \hline
  ...
  \hline
  \textbf{Links} & \url{https://www.pi-shop.ch/pimoroni-display-o-tron-3000} & \url{https://de.wikipedia.org/wiki/Leuchtdiode#:~:text=Eine%20Leuchtdiode%20(kurz%20LED%20von,sperrt%20die%20LED%20den%20Strom.}\\
  \hline
...
\begin{tabularx}{\textwidth}{|l|X|X|}
\hline
  \textbf{} & \textbf{Display} & \textbf{LED's} & \textbf{}\\
  \hline
