...
\begin{tabularx}\textwidth{X X X }
    \textbf{Maschinentechnik} & \textbf{Elektrotechnik} & \textbf{Informatik} \\
    &&\\
    Werkstoffe  & Eingabeoptionen & Wegfindung\\ 
    Fortbewegung  & Ausgabeoptionen & Bilderkennung\\ 
    Lenkung  & Stromversorgung & \\ 
    Hebevorrichtung  & Antriebe & \\ 
    & Objekterkennung & \\ 
    & Steuerung & \\ 
\end{tabularx}
\end{table}
...
Es gibt verschiedneste Arten einen Roboter autonom fortzubewegen. Aufgrund der vielen Möglichkeiten wurden bei einem Brainstorming im Team Varianten die zu Komplex oder aufwendig in der Umsetzung sind bereits ausgeschlossen, ohne Recherche zu betreiben. Unten aufgeführt sind die beiden Varianten, welche weiter verfolgt wurden.
...
\textbf{} & \textbf{Raupen} & \textbf{Räder} \\
  ...
  \hline
  \textbf{Links} & \url{https://spacecraft.ssl.umd.edu/academics/788XF22/788XF22L23.tracks.pdf} & \url{https://gtfrobots.com/introduction-to-types-of-robot-wheels/} \\
  \hline
\end{tabularx}
...
\textbf{} & \textbf{Mecanumwheel} & \textbf{Überlagerungslenkgetriebe} \\
  ...
  \hline
  \textbf{Links} & \url{https://www.generationrobots.com/media/Mecanum-wheel-application.pdf?srsltid=AfmBOorTpuZt7XtV3qQiRZx3OUkmpaGSvG7AvhzuWbz61Fu4mzv7UaZ2} & \url{https://de.wikipedia.org/wiki/Überlagerungslenkgetriebe} \\
  \hline
  
  \hline
  \textbf{} & \textbf{Lenkgetriebe} & \textbf{Differential Wheel Drive} \\
  \hline
  \textbf{Beschreibung}  & Umwandlung Rotation in unterschiedliche Einschlagwinkel an den Rädern& 2 einzeln Angetriebene Räder, 1 Schwenkrad \\
  \hline
