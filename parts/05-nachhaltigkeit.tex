...
Der Prototyp wurde so aufgebaut das er möglichst Modular ist. Die Grundplatte wurde bewusst etwas grösser gewählt und aus einem Material, das sich leicht bearbeiten lässt. Bei änderungen können so einzelne Halterungen und Montage einrichtungen separat ausgetauscht werden ohne das Grosse Teile neu aus PLA Gedruckt werden mussten. 
