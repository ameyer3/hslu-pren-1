...
Es werden nicht zwei komplette Roboter Protoypen erstellt, um parallel zu arbeiten. Dies ist nicht noetig, weswegen nur Teil-Prototypen erstellt werden. Dabei wird versucht so viel Material wie noetig und so wenig wie moeglich zu verwenden.
