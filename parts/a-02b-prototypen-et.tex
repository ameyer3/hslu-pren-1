...
Im Rahmen des Projekts wurden 25 Pins verwendet\ref{fig:Tiny_K22_Pinout_definition}. Die zeitkritischen Funktionen werden direkt auf dem \acrshort{tinyk22} verarbeitet. Dabei werden folgende Zuweisungen vorgenommen:
