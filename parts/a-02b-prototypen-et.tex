...
Das Tiny K22 PCB bietet insgesamt 28 Pins (Abb. \ref{fig:Tiny_K22_PCB}). Diese Pins können flexibel als Timer, ADC, IIC, SPI, UART, Input- oder Output-Pins konfiguriert werden.
