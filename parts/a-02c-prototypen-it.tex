...
Objekterkennung - which algo?
Yolov11 - Cone, Line, Node, Obstacle
Yolov11 - Cone, node, obstacle
...
Damit die Fortbewegung inklusive Linienerkennung implementiert werden kann, benoetigt es vor allem die Raeder und die Motoren. Diese wurden an einem Holzbrett befestigt, das ebenfalls verwendet werden kann, um die zusaetzlichen Sensoren und Rechner anzubringen, die fuer die Steuerung benoetigt werden. 

BILD

\subsubsection{Greifer}

Es wurde ein Greifer gebaut, der an einen Motor angeschlossen ist. Dieser wird verwendet, um das Anheben des Hindernisses zu implementieren und zu kombinieren mit dem Rest des Roboterprototypes.
