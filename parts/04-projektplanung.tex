...
Im Rahmen der Projektplanung wurden die Termine und die zu bearbeitenden Aufgaben festgelegt und einzelnen Sprints zugeordnet. Ergänzend dazu wurde eine Risikobewertung erstellt.
...
Die folgende Abbildung \ref{fig:roadmap} zeigt die Roadmap mit den definierten Meilensteinen. Die Meilensteine bilden die einzelnen Testatabgaben.
Die Erstellung der abzugebenden Dokumente pro Testat bilden die einzelnen Sprintziele.
...
\begin{itemize}
    ...
    \item Technologierecherche durchgeführt
\end{itemize}
...
\hline
  ...
  \hline
  1.3 & Ziele definieren & Definieren, wie das Team sich den Roboter vorstellt. & S\\
  \hline
...
Alle definierten Ziele wurden erreicht. Die geplanten Dokumente wurden erstellt und in einen Entwurf des Schlussberichts eingefügt.
...
\hline
  ...
  \hline
  1.1  & Workshop Auschlusskriterien & Brainstorming, um herauszufinden, wie der Roboter sicher nicht aussehen soll, um Technologien auszuschliessen. & S\\
  \hline
...
In diesem Sprint kam das Risiko 7: Ein Objekt wird fehlerhaft gedeutet und falsche Wege werden intern entfernt hinzu. Dies wurde erstellt nach ersten Tests mit Bilderkennungssoftwares. Es wurde dabei festgestellt, dass der Boden in der Mensa stark spiegelt, wasdie Erkennung von Knoten erschwert. Dies hat zur Folge, dass die Detektion des genauen Standorts der Hindernisse erschwert.
...
\hline
  ...
  \hline
  1.1  & Konzept Chassis (M) &  Das Konzept der Form wird definiert. & S\\
  \hline
...
\hline
  ...
  \hline
  1.1  & Fertigstellung Dokumentation & Die Dokumentation wird fertiggestellt & L\\
  \hline
  2 & \textbf{Prototyping} && \\
  \hline
