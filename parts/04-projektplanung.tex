...
Die Risiken des Projektes sind gesammelt und bewertet worden. Pro Risiko wurden Massnahmen zur Praevention und zur Mitigation gesammelt.
Zusaetzlich zu den definierten Massnahmen sollen mithilfe von Prototypen so viele Risiken wie möglich, so gut wie möglich vermindert werden. 
...
Dieselbe Matrix wurde erstellt fuer die Risiken nach den definieren der Massnahmen.
