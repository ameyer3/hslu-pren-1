...
\hline
  ...
  \hline
  2.2 & Konzept erarbeiten & Konzept des Simulators definieren. & M \\
  \hline
...
\hline
  ...
  \hline
  1.2  & Konzept Lenkung (M) & Die Lenkung des Roboters wird definiert.& M\\
  \hline
  1.3 & Konzept Hindernisse bewegen (M/ET) & Es wird definiert, wie Hindernisse bewegt werden sollen. & M\\
  \hline
  1.4 & Konzept Stromversorgung (ET) & Die Stromversorgung wird definiert. & M\\
  \hline
  1.5 & Konzept Antriebe (ET) & Der Antrieb wird definiert. & M\\
  \hline
  1.6 & Konzept Objekterkennung (ET) & Es wird definiert, wie Objekte erkannt werden. & M\\
  \hline
  1.7 & Konzept Steuerung (ET/I) & Es wird definiert, wie der Roboter gesteuert wird. & M\\
  \hline
    1.8 & Konzept Wegfindung (I) & Es wird definiert, wie der Weg, den der Roboter gehen soll, ausgewählt wird.  & M\\
\hline
    1.9 & Konzept Bilderkennung (I) & Es wird definiert, wie das Wegenetzwerk und die Hindernisse erkannt werden. & M\\
\hline
...
\hline
  1.11  & Risikobewertung & Die Risikobewertung für das Gesamtkonzept wird durchgeführt. & M \\
  \hline 
  2  & \textbf{Simulator} &&\\
  \hline
...
Wegenetzwerk einlesen: YAML / JSON / Bild

Wegenetz intern speicher: Graph mit Library / 2D Liste

Bewegliche Hindernisse markieren: mittels Gewichtung (kein Hindernis=1, Hindernis=2) / ...

Blockeirte Knoten: Markieren / Aus intern gespeichertem Netz entfernen

Wegfindung: selber implementieren / Library verwenden (https://networkx.org/documentation/networkx-1.10/reference/generated/networkx.algorithms.shortest_paths.astar.astar_path.html , https://pypi.org/project/astar/)

Zielauswahl: Human input / Random / nach Berechnung Roboter waehlt

Clientseitig: GUI, CLI, keine